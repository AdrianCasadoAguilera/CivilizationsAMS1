...
import com.project.RocketLauncherTower;
...
public class RocketLauncherView extends JPanel {
    ...
    private String unitName = "Rocket Launcher Tower";
    private String descString = "When in doubt, blow it up—subtlety is overrated.";
    ...
    public MilitaryUnit unit = new RocketLauncherTower();

    public RocketLauncherView(){
    ...
    private void setTitle(){
        JPanel titlePanel = new JPanel();
            ...
            photoPanel.setOpaque(false);
                URL link = getClass().getResource("/com/project/UI/src/rocket_launcher.png");
