...
public class MagicianView extends JPanel {
    ...
    private String unitName = "Magician";
    private String descString = "Making enemies disappear, and occasionally his own hat.";
    ...
    public MilitaryUnit unit = new Magician();
    ...
    private void setTitle(){
        JPanel titlePanel = new JPanel();
            ...
            photoPanel.setOpaque(false);
                URL link = getClass().getResource("/com/project/UI/src/magician.png");
