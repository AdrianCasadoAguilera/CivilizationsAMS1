...
public interface Variables {
    ...
    // COST ATTACK UNITS
    public final int FOOD_COST_SWORDSMAN = 500;
    public final int FOOD_COST_SPEARMAN = 500;
    public final int FOOD_COST_CROSSBOW = 500;
    public final int FOOD_COST_CANNON = 500;
    public final int WOOD_COST_SWORDSMAN = 500;
    public final int WOOD_COST_SPEARMAN = 500;
    public final int WOOD_COST_CROSSBOW = 500;
    public final int WOOD_COST_CANNON = 500;
    public final int IRON_COST_SWORDSMAN = 500;
    public final int IRON_COST_SPEARMAN = 500;
    public final int IRON_COST_CROSSBOW = 500;
    public final int IRON_COST_CANNON = 500;
    public final int MANA_COST_SWORDSMAN = 500;
    public final int MANA_COST_SPEARMAN = 500;
    public final int MANA_COST_CROSSBOW = 500;
    public final int MANA_COST_CANNON = 500;
